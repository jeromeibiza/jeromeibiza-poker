      ...
      <Section kicker="Pour aller plus loin" title="Approfondir le métier">
        <div className="grid-cards">
          {[
            ...
            ["✅ Le test d'embauche", "Comment se passe l'audition, ce qu'on évalue et comment se préparer.", "/croupier/test-embauche"],
            ["🌍 Croupier à l'étranger", "Malte, Londres et festivals : partir dealer les plus gros événements.", "/croupier/a-l-etranger"],
            ["🔁 En reconversion", "Un métier accessible à tout âge, jugé sur la pratique pas sur le diplôme.", "/croupier/reconversion"],

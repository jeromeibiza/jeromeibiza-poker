...
export const metadata: Metadata = {
  title: "Glossaire poker complet : tous les termes de A a Z, expliques",
  description:
    "Le dictionnaire du poker : plus de 70 termes (et en croissance) definis simplement, " +
...
export default function GlossairePage() {
  const defLd = {
    ...
    "@type": "DefinedTermSet",
    name: "Glossaire poker — Jerome Ibiza",
  ...
  return (
    <div className="wrap">
      ...
      <PageHero
        ...
        intro="Tous les mots du poker, definis simplement et illustres d'exemples concrets. Tape un terme dans la recherche ou filtre par lettre. Un doute en pleine partie ? La reponse est ici."
      />
      ...
      <div className="card" style={{ marginTop: 32, borderColor: "rgba(232,176,75,0.3)" }}>
        ...
        <p style={{ marginTop: 8, color: "var(--muted)" }}>
          ...
          Il sera ajoute dans une prochaine mise a jour.
        </p>
      </div>
    </div>
  );

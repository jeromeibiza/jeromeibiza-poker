...
export const metadata: Metadata = {
  ...
  description:
    ...
    "et de ROI de tournoi. Gratuits et expliques.",
  alternates: { canonical: "/calculateurs" },
};

const CALCS = [
  { href: "/calculateurs/cotes", title: "Calculateur de cotes", desc: "Pot odds, outs et equite : faut-il suivre ?", ready: true },
  { href: "/calculateurs", title: "Calculateur de bankroll", desc: "Combien de caves avoir selon ton format et ton risque.", ready: false },
  { href: "/calculateurs", title: "Calculateur d'ICM", desc: "Convertir des tapis de tournoi en valeur monetaire.", ready: false },
  { href: "/calculateurs", title: "Calculateur de rake", desc: "Estimer le rake preleve sur tes sessions.", ready: false },
  { href: "/calculateurs", title: "Calculateur de ROI tournoi", desc: "Mesurer ta rentabilite en tournoi.", ready: false },
];
  ...
  return (
    <div className="wrap">
      ...
      <PageHero
        ...
        intro="Des outils simples pour prendre de meilleures decisions et suivre tes resultats. Le calculateur de cotes est deja en ligne ; les autres arrivent."
      />
